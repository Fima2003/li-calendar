            ...
            <div className="w-full max-w-md space-y-8 rounded-xl border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                ...
                <div className="mt-8">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-3 rounded-lg border-2 border-black bg-white px-4 py-3 text-sm font-bold text-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-[4px] active:translate-y-[4px] active:shadow-none"
                    >
